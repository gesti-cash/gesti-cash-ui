...
const navSections: NavSection[] = [
  ...
  },
  {
    title: "Achat",
    items: [
      { title: "Fournisseur", href: "/suppliers", icon: Truck },
      { title: "Bon de commande", href: "/purchase-orders", icon: ClipboardList },
    ],
  },
  {
    title: "Vente",
    items: [
      { title: "Client", href: "/customers", icon: Users },
      { title: "Commande", href: "/orders", icon: ShoppingCart },
      { title: "Livreur", href: "/delivery", icon: UserCircle },
    ],
  },
  {
    title: "Stock",
